...
export default function Statistics() {
  return (
    <header className="mx-auto py-6" style={{ backgroundColor: "#060714" }}>
      <div className="flex justify-center items-center h-auto sm:h-screen">
        <div className="max-w-3xl gap-12 flex w-full border rounded-xl p-6 sm:p-4" style={{ backgroundColor: "#060714" }}>
          
          <div className="w-full sm:w-[250px] md:w-[320px]">
            <Image
              src="/Item (16).png"
              alt="Item"
              width={320} 
          ...
          <div className="w-full sm:w-auto">
            ...
            {/* Price and Timer */}
            <div className="w-full sm:w-64 mt-2 border rounded-lg p-4">
              ...
              {/* Button */}
              <button className="w-full mt-4 py-1 px-6 text-white rounded-lg" style={{ backgroundColor: "#4745D0" }}>
                Place a bid
              </button>
            </div>
