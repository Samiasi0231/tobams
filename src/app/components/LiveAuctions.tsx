...
const NFTCard = ({ image, title, timeLeft, ethPrice, bidders = [], likes }: NFTCardProps) => {
  return (
    <div className="bg-gray-950 p-4 rounded-lg border border-gray-300 flex-shrink-0 w-full sm:w-[280px] h-[510px] flex flex-col">
      {/* NFT Image */}
...
const LiveAuctions = () => {
  ...
  const nftData = [
    ...
    {
      image: "/Image (3).png",
      title: "Vestibulu scelerisque viverra",
      timeLeft: "12:10",
      ethPrice: "3.00",
    ...
    {
      image: "/Image (21).png", 
      title: "Malesuada faucibus faucibus",
      timeLeft: "5:45",
      ethPrice: "4.22",
      bidders: ["/01.png", "/02.png", "/03.png"],
      likes: 690,
  ...
  return (
    <section style={{ backgroundColor: "#060714" }} className="w-full text-white text-center px-4 sm:px-20 py-8">
      <h1 className="text-xl font-bold mb-4">Latest Live Auctions</h1>
